...
// I added check_invalid function so that it works like example (can print "Invalid item!")
...
void check_invalid(string item);
...
float get_cost(string item)
{
    ...
    return 0.0; // There has to be a return value outside for loop
}
